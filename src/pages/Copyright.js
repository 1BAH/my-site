...
const Copyright = () => (
    <Template title="JK Copyrights" description="Copyrights">
        ...
        <div className={styles.block}>
            Все материалы сайта составлены непосредственно автором. Копирование возможно только с указанием авторства или с согласия (
